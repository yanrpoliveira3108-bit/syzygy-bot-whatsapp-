...
export async function roteadorAcoes(chatJid, ownerKey, actionId) {
    ...
    if (
        ...
        actionId.startsWith("flood_") ||
        actionId === "cfg_flood_dryrun" ||
        actionId === "cfg_flood_allowlist" ||
        actionId === "cfg_flood_testmode"
    ) {
